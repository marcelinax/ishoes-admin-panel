...
export const ProductCard = () => {
    return (
        <div className='basis-1/3 h-2/6 p-10 flex shadow-[0_0_15px_rgba(0,0,0,0.15)] mx-5 rounded-lg relative'>
            {/* <div className='text-sm text-white font-semibold py-1 px-4 bg-gray absolute top-0 right-0 rounded-tr-lg'>Out of Stock</div> */}
            ...
            <div className='w-1/2 ml-6 py-5 flex flex-col justify-between'>
                <div>
                    ...
                    <div className='w-full flex flex-col justify-between'>
                        ...
                        <p className='text-red font-semibold'>$350</p>
                    </div>
                </div>
                <div className='w-full flex items-center'>
                    <ButtonWithIcon icon={<BiPencil size={20}/>} className='mr-3'/>
                    <ButtonWithIcon icon={<BiTrashAlt size={20} className='fill-red' />} />
                    {/* <div className='text-white text-sm font-semibold py-1 px-4 bg-gray ml-5'>Out of Stock</div> */}
                </div>
            </div>
        </div>
    );
